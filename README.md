# 🧶 Sweater — AI Context Transfer & Intelligence Platform MVP - A Browser Extension no installation directly Download Zip and open developer mode and make it pack unload and sweater is ready to use
